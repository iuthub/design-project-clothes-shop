        ...
        <div class="container"> <!-- container Begin -->   
            <div class="navbar-header"> <!-- navbar-header Begin -->
                ...
                <a href="index.php" class="navbar-brand">
                    <img src="images/ecom-store-logo.png" alt="Clothes Shop Logo" class="hidden-xs">
                    <img src="images/ecom-store-logo-mobile.png" alt="Clothes Shop Logo Mobile" class="visible-xs">
                </a>
                ...
                <div class="box"> <!-- box Begin -->
                    <div class="box-header"> <!-- box-header Begin -->
                        <center>
                            ...
                            <p class="text-muted">If you have any questions, feel free to contact us. Our customer service work <strong>24/7</strong></p>
                        </center>
